    ...
    override fun visit(
        ...
        if (node is FileElement) {
            ...
            lines.forEachIndexed { i, line ->
                ...
                if (line.length < maximumLineLength || partOfImportList) return@forEachIndexed

                emit(
                        offset,
                        "This line is too long. Shorten it to less than $maximumLineLength chars",
                        false
                )
            }
        }
